    ...
    <div className='flex flex-col  text-neutral-700 bg-neutral-200'>
      {
        carrito.length > 0 && carrito !== undefined ?
          <main className='flex flex-col mx-10 my-10 px-20 overflow-hidden'>
            
            <section className='flex flex-col bg-neutral-50 rounded px-20 p-10 w-full h-full'>
            ...
            <main className='flex flex-col overflow-hidden self-center'>
                ...
                <h2 className="my-5 p-5 text-6xl font-extralight self-center ">Actualmente no tiene ningun producto en el carrito</h2>
