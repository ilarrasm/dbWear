...
export default function Item({id, nombre, descripcion, precio, img}) {
    ...
    return (
    <div key={id} className='flex flex-col w-full h-full rounded overflow-hidden text-neutral-700 self-center my-5'>
        
        <img src={img} alt={descripcion}  className='h-40 w-full  object-cover'/>
